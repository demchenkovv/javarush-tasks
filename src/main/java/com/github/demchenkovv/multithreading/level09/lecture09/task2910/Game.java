package com.github.demchenkovv.multithreading.level09.lecture09.task2910;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

import static com.github.demchenkovv.multithreading.level09.lecture09.task2910.Constants.*;
...
public class Game {
    ...
    private void initializeControlSportsman() {
        ...
        controlSportsman.setResultTime(new BigDecimal("3640.00")); // Было 3640.0. Ошибка! Помог дебаг.

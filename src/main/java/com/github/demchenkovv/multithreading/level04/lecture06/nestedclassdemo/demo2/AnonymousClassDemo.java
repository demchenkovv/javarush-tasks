...
// не можем обратиться к нему по такому имени.
// Обобщенно "внешнийКласс$n.class" - на месте внешнего класса, соответственно, название обрамляющего класса,
// внутри которого описывается анонимный внутренний класс. На месте n число от 1 до количества анонимных классов.

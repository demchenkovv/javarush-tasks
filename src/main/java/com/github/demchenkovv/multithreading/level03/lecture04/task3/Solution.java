package com.github.demchenkovv.multithreading.level03.lecture04.task3;
...
public class Solution {
    ...
    /* Чтобы внешнему классу вызвать метод getDescription() внутреннего private класса,
    нужно обернуть его вызов в какой-то public метод внешнего класса */

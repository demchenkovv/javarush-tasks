package com.github.demchenkovv.multithreading.level06.lecture05.task2604;
...
public class Solution extends Thread {
    ...
    // Волатильность подразумевает, что поле будет меняться.
    // Если оно финальное, то вы никогда не измените его.

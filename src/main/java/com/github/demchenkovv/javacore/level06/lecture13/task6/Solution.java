package com.github.demchenkovv.javacore.level06.lecture13.task6;
...
/**
 * Обратите внимание на название задачи: РЕКУРСИВНОЕ создание нитей.
 * Поэтому циклов тут быть не должно.
 * Созданная нить запускает run(), которая создает новую нить, которая запускает run(), которая создает ..... и  так пятнадцать раз.
  */
...
//            // С if - простая рекурсия, с while - параллельная рекурсия.

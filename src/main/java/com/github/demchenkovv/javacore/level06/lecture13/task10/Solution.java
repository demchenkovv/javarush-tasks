package com.github.demchenkovv.javacore.level06.lecture13.task10;
...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            long stepsPerSecond = 1000 / this.rating;

            try {
                for (int i = 0; i < OnlineGame.steps.size(); i++) {
                    System.out.println(this + OnlineGame.steps.get(i));
                    Thread.sleep(stepsPerSecond);
                }

package com.github.demchenkovv.javacore.level04.lecture04.task2;
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        String somename = bufferedReader.readLine();
//        while (!somename.isBlank()) { валидатор не понимает isBlank()
        while (!somename.equals("")) {
            Cat cat = CatFactory.getCatByKey(somename);
            System.out.println(cat.toString());
            somename = bufferedReader.readLine();
        }
    }

package com.github.demchenkovv.javasyntaxzero.other.extendsDemo;

/**
 * Очень важно запомнить на будущее, что при создании объекта
 * в первую очередь вызывается конструктор его базового класса,
 * а только потом — конструктор самого класса, объект которого мы создаем.
 * <p>
 * url: https://javarush.com/groups/posts/1927-konstruktorih-bazovihkh-klassov--
 */
public class Animal {

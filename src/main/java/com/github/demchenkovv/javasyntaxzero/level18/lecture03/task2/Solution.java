package com.github.demchenkovv.javasyntaxzero.level18.lecture03.task2;
...
а именно — поток автомобилей, у которых поле isElectric равно true. В этом тебе поможет метод filter()
